...
<div class="container">
 ...
 <header>
	...
	<div align="center">
		...
		<div>
			<form action="/adminproductadd" id="linkId">
				<input type="submit" class="btn btn-danger" value="Add a New Product" />
			</form>
		</div>
				 ...
				 <tbody>
					<c:forEach items="${tasks}" var="tsks">
						<tr>
							...
							<td>${tsks.price}</td>
							<td><a type="button" class="btn btn-success" href="/adminproductsedit/${tsks.id}">Edit</a></td>
							<td><a type="button" class="btn btn-success" href="/adminproductdelete/${tsks.id}">Delete</a></td>
